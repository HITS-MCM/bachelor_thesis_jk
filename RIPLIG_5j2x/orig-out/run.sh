...
/scratch/mcm/trapp/software/anaconda3/envs/py2/bin/python -s /share/apps/mcm/trapp4/trapptool/scripts/trapp-analysis.py structure_5j2x.pdb contact_residues_ref_analysis.dat     -zmax 8.0 -bb  -cluster 3.0  > trapp-analysis-bb.log & 
 wait 
